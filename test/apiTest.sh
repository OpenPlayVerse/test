...
request:set_body([[{"tag_name":"v0.0.5","target_commitish":"master","name":"pleal test","body":"Description of the release","draft":false,"prerelease":false,"generate_release_notes":false}]])
